...
export default function RandomBird({ song, style }: Props) {
    ...
    const renderButtonSound = () => {
        return (
            ...
            <div onClick={() => { toggleAudio() }} className={style.playbackButton}>
            ...
            <div className={style.playerContainer}>
                ...
                <div className={style.progressb}>
                    <input
                        ...
                        type="range" name={style.progresBar} />
                </div>
            </div >
            <div className={style.songTime}>
                <span className={style.currentT}>{fmtMSS(currentTime)}</span>
                <span className={style.totalT}>{fmtMSS(dur)}</span>
            </div>
        </>
