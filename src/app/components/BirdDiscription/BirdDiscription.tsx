...
export default function BirdDiscription() {
    return (
        <div className={styles.container}>

            <img src='https://live.staticflickr.com//65535//48701190276_ee2a9ed594.jpg' alt="" className={styles.birdImage} />
            <div>
                <h1 className={styles.h1Style}>Питисса</h1>
                <h2 className={styles.birdEnglishName}>Питисса2</h2>
                ...
                <h2 className={styles.birdDiscription}>ipsum dolor sit amet consectetur, adipisicing elit. beatae blanditiis magni quidem eius, soluta eligendi!Lorem ipsum dolor sit amet consectetur, adipisicing elit. beatae blanditiis magni quidem eius, soluta eligendi!</h2>
